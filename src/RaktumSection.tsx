  ...
  return (
    <>
      ...
      <div className="sm:col-span-3">
        <Field>
          ...
          <RadioGroup onChange={onRezimChange} className="mt-6 space-y-2">
            {[
							{ id: '1', label: 'Neoadjuvance - Samostatná akcelerovaná radioterapie + standardní odstup operace' },
							{ id: '2', label: 'Neoadjuvance - Samostatná akcelerovaná radioterapie + krátký odstup operace' },
							{ id: '3', label: 'Neoadjuvance - Konkomitantní chemoradioterapie' },
							{ id: '4', label: 'Totální neoadjuvance - akcelerovaná radioterapie + 6x CAPOX ' },
							{ id: '5', label: 'Totální neoadjuvance - akcelerovaná radioterapie + 9x FOLFOX ' },
							{ id: '6', label: 'Totální neoadjuvance - chemoradioterapie + 6x CAPOX ' },
							{ id: '7', label: 'Totální neoadjuvance - chemoradioterapie + 9x FOLFOX ' },
      ...
      <div className="sm:col-span-4"></div>
				...
				<Field>
					...
					<RadioGroup value={frakcionace} onChange={setFrakcionace} className="mt-6 space-y-2">
						{[
							...
							{ id: 'PTV+SIB', label: 'PTV low 45Gy (25x1,8Gy) + SIB PTV high 50Gy (25x2Gy)' },
							{ id: 'PTV 45', label: 'PTV low 45Gy (25x1,8Gy) + PTV high 20-24Gy (10-12x2Gy)' },
							{ id: 'PTV 46', label: 'PTV low 46Gy (23x2Gy) + PTV high 20-24Gy (10-12x2Gy)' },
			...
			<div className="sm:col-span-3">
				<Field>
					...
					<RadioGroup value={chemoterapie} onChange={setChemoterapie} className="mt-6 space-y-2">
						{[
							{ id: 'konkomitantni-chemoterapie', label: 'Konkomitantní chemoterapie Kapecitabin 825mg/m2 2xd' },
							{ id: 'konkomitantni+capox', label: 'Konkomitantní chemoterapie Kapecitabin 825mg/m2 2xd + CAPOX 6x po ukončení radioterapie' },
							{ id: 'konkomitantni+folfox', label: 'Konkomitantní chemoterapie Kapecitabin 825mg/m2 2xd + FOLFOX 9x po ukončení radioterapie' },
			...
			<div className="sm:col-span-2">
				<Field>
					<Label htmlFor="odstup" className="block text-sm/6 font-medium text-gray-900">
						Odstup operace
					</Label>
					<RadioGroup value={odstup} onChange={setOdstup} className="mt-6 space-y-2">
						{[
